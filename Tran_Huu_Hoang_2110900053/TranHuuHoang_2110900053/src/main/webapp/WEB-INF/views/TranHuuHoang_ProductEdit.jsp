...
<body>
	<section class="container">
		...
		<c:if test="${empty product}">
			<a href="TranHuuHoang_ProductList"> Quay lại</a>
		</c:if>
		<c:if test="${not empty product}">
			<form method="POST" action="${pageContext.request.contextPath}/TranHuuHoang_ProductEdit">
				<table class="table table-bordered">
					<tr>
						<td>Mã SP</td>
						<td><input type="text" name="maSP_2110900053" value="${product.maSP_2110900053}" readOnly /></td>
					</tr>
					<tr>
						<td>Tên SP</td>
